...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'profile-categories': ProfileCategoriesSelect<false> | ProfileCategoriesSelect<true>;
...
export interface Profile {
  id: number;
  name: string;
  category: number | ProfileCategory;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "profile-categories_select".
 */
